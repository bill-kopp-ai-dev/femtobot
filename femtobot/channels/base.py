...
class BaseChannel(ABC):
    ...
    to integrate with the femtobot message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from femtobot.providers.transcription import OpenAITranscriptionProvider
                ...
                from femtobot.providers.transcription import GroqTranscriptionProvider
