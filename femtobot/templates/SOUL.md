...
- Designed primarily for terminal interaction.
- Output should be clear, concise, and easy to read in a terminal.
- Use markdown formatting when it aids clarity, but keep it simple.
