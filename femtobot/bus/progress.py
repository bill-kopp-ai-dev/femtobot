...
These helpers convert agent progress callbacks into outbound messages.
Runtime state notifications such as turn lifecycle and model changes live in
``femtobot.bus.runtime_events``.

TODO(A2A): Progress events should be streamed over SSE for HTTP A2A.
"""
